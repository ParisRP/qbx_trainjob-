...
-- ============================================
-- CONFIGURATION DES SIÈGES ET PERMISSIONS
-- ============================================
Config.Seats = {
    -- Sièges accessibles à tous les joueurs
    publicSeats = {
        "seat_dside_r",
        "seat_pside_r", 
        "seat_pside_r1",
    ...
    -- Sièges réservés au métier train (conducteur + passager avant)
    jobSeats = {
        "seat_dside_f",  -- Siège conducteur
        "seat_pside_f"   -- Siège passager avant
    }
}
...
Config.Collision = {
    enabled = true,
    enableOnSpawn = true,
    enableAfterDelay = 100,
    disableOnJobEnd = true,
    forceOpaque = true,
    aggressiveCollisionCheck = true,
    checkInterval = 100
}

-- ============================================
-- CONFIGURATION DES PORTES ET VERROUILLAGE
-- ============================================
Config.LockTrainOnDoorClose = true  -- Verrouiller automatiquement le train quand les portes sont fermées
Config.AutoLockDelay = 10000  -- Délai avant verrouillage automatique (10 secondes)
Config.ManualDoors = true  -- Contrôle manuel des portes par le conducteur

Config.Framework = "QBCore"
Config.TargetSystem = true
...
Config.Language = {
    npc_help_notification = "Press [E] to start the train job",
    wait_at_station = "Waiting for passengers...",
    not_at_station = "You must stop at the station!",
    job_started = "Train job started! Use [W] to accelerate, [S] to brake, [G] for the doors",
    miss_station = "You missed the station! Continue to the next stop",
    job_ended = "Train job ended!",
    mission_text_1 = "Press ~p~G~s~ to open/close the doors",
    ...
    job_complete_bonus = "Route complete! Bonus: $%d",
    station_complete = "Station completed: +$%d",
    exited_train = "You have exited the train. Approach the train and press F to re-enter.",
    reentering_train = "You have re-entered the train.",
    stop_job_command = "Use /stoptrainjob to completely stop the job.",
    use_exit_command = "Use /exittrainjob to exit the job.",
    seat_restricted = "This seat is reserved for train personnel",
    no_seat_available = "No available seat",
    enter_any_seat = "Press F to enter the train as passenger",
    entered_as_passenger = "You entered the train as passenger",
    train_locked = "Train is locked",
    train_unlocked = "Train is unlocked",
    doors_opened = "Doors opened",
    doors_closed = "Doors closed",
    doors_locked = "Doors closed and train locked",
    manual_doors_info = "Press G to open/close doors manually",
    lock_instructions = "Press L to lock/unlock the train or use /locktrain",
    train_already_locked = "Train is already locked",
    train_already_unlocked = "Train is already unlocked",
}
